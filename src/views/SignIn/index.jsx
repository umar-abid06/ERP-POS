    ...
    <div >
      <div className="signin">
        ...
        /> 
          <h1 className="r">
            SoftSol ERP </h1>
            <h1 style={{marginTop:"-4%",marginLeft:'-3%'}}>Sign In Please...</h1>
          ...
          <div className="inputs">
            ...
            />
            <input
            style={{border:"2px solid black",backgroundColor:"whitesmoke"}}
              type="password"
              required
